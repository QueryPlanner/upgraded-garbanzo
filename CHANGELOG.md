...
### Changed
- Renamed project to **Garbanzo** with updated README reflecting capabilities (fitness tracking, reminders, web search, context files, YouTube transcripts, MCP tools).
...
[Unreleased]: https://github.com/QueryPlanner/upgraded-garbanzo/compare/v0.2.0...HEAD
[0.2.0]: https://github.com/QueryPlanner/upgraded-garbanzo/compare/v0.1.1...v0.2.0
[0.1.1]: https://github.com/QueryPlanner/upgraded-garbanzo/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/QueryPlanner/upgraded-garbanzo/releases/tag/v0.1.0
